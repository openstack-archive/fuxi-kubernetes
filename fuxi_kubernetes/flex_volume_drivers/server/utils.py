...
def get_root_helper():
    return 'sudo fuxi-k8s-rootwrap %s' % local_config.CONF.rootwrap_config
...
def brick_get_connector_properties(multipath=False, enforce_multipath=False):
    ...
    return connector.get_connector_properties(
        get_root_helper(), local_config.CONF.my_ip,
...
def get_cinder_client(*args, **kwargs):
    ...
    return cinder_client.Client(
        ...
        region_name=local_config.CONF.cinder.region_name,
        version=2)
